...
public class MaxHitPlugin extends Plugin {
	...
	public void getEquippedItemsIds() {
		...
		equippedItemIds.put("weapon", equippedItems[EquipmentInventorySlot.WEAPON.getSlotIdx()].getId());
		equippedItemIds.put("body", equippedItems[EquipmentInventorySlot.BODY.getSlotIdx()].getId());
		equippedItemIds.put("shield", equippedItems[EquipmentInventorySlot.SHIELD.getSlotIdx()].getId());
		equippedItemIds.put("legs", equippedItems[EquipmentInventorySlot.LEGS.getSlotIdx()].getId());
		equippedItemIds.put("gloves", equippedItems[EquipmentInventorySlot.GLOVES.getSlotIdx()].getId());
		equippedItemIds.put("boots", equippedItems[EquipmentInventorySlot.BOOTS.getSlotIdx()].getId());
		equippedItemIds.put("ring", equippedItems[EquipmentInventorySlot.RING.getSlotIdx()].getId());
		equippedItemIds.put("ammo", equippedItems[EquipmentInventorySlot.AMMO.getSlotIdx()].getId());
	}
	...
	public double getEquippedWeaponMaxHit() {
		return maxHitBase(combatType());
	}
